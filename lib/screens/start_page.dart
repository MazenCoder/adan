...
import 'package:adan/shared_pref/first_user_pref.dart';
import 'package:adan/helpers/permission_handler.dart';
...
class _StartPageState extends State<StartPage> {
  ...
  startHomePage() async {
    ...
    try {
      ...
      List<Salah> salahList = await db.salahsDao.getAllSalah();
